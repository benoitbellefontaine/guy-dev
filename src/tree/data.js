...
export default { 
    ...
    children: [ 
        ...
        { name: 'court terme', type:'link', 
            ...
            icon: "fas fa-plane-departure fa-1x",
            children: [
        ...
        { name: 'excellence', type:'switch',
            ...
            icon: "fas fa-trophy fa-1x",
            children: [
                { name: 'planification stratégique', type:'hotspot', color:'linear-gradient(to right, rgb(148,103,189), rgb(98,73,139), rgb(148,103,189))' },
                { name: 'plan de relève', type:'link', color:'linear-gradient(to right, rgb(148,103,189), rgb(98,73,139), rgb(148,103,189))' },
                { name: 'tableau de bord (scorecard)', type:'hotspot', color:'linear-gradient(to right, rgb(148,103,189), rgb(98,73,139), rgb(148,103,189))' },
                { name: 'analyse de la chaine des valeurs', type:'link', color:'linear-gradient(to right, rgb(148,103,189), rgb(98,73,139), rgb(148,103,189))' },
                { name: 'rigueur & discipline', type:'hotspot', color:'linear-gradient(to right, rgb(148,103,189), rgb(98,73,139), rgb(148,103,189))' },
                { name: 'plans quinquennaux', type:'link', color:'linear-gradient(to right, rgb(148,103,189), rgb(98,73,139), rgb(148,103,189))' },
            ]   
        },
        { name: 'redressement', type:'switch', 
            textcolor:'rgb(140,86,75)',
            color:'url('+khalifa+')',
            icon: "fas fa-procedures fa-1x",
            ...
            children: [
                { name: 'respirateur artificiel', type:'hotspot', color:'linear-gradient(to right, rgb(140,86,75), rgb(180,116,105), rgb(140,86,75))'},
                { name: 'consolidation de dettes', type:'link', color:'linear-gradient(to right, rgb(140,86,75), rgb(180,116,105), rgb(140,86,75))' },
                { name: 'recherche de nouveaux investisseurs', type:'hotspot', color:'linear-gradient(to right, rgb(140,86,75), rgb(180,116,105), rgb(140,86,75))' },
                { name: 'réingénierie', type:'link', color:'linear-gradient(to right, rgb(140,86,75), rgb(180,116,105), rgb(140,86,75))' },
                { name: 'plan de revitalisation', type:'hotspot', color:'linear-gradient(to right, rgb(140,86,75), rgb(180,116,105), rgb(140,86,75))' },
                { name: 'refinancement', type:'link', color:'linear-gradient(to right, rgb(140,86,75), rgb(180,116,105), rgb(140,86,75))' },
            ]     
        }
    ]
}